...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('projects', '0005_projects_country'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='projects.projects')),
